...
export default function Home() {
  ...
  <div className="mt-40 ">
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">One solution to take control of your finances</h2>
    ...
    <section className="py-20 bg-blue-300">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands already managing their finances smarter</p>
        <Link href="/dashboard">
        <Button
        size="lg"
